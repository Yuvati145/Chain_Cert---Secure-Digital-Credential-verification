  ...
  return (
    <div className="wrap">
      <section className="hero card">
        <div>
          <span className="pill">Owner Console</span>
          <h1>Issue Certificates</h1>
          <p>
            Issue and revoke certificates as the contract owner. Verification is available on a
            separate page.
          </p>
          <div className="row" style={{ marginTop: "12px" }}>
            ...
            <a className="btn" href="./verify.html">
              Go to Verify
            </a>
          </div>
        </div>
      ...
      <section className="grid">
        <div className="card">
          ...
          <div className="input-row">
            ...
            <button
              ...
              type="button"
              onClick={() => {
                if (!issueForm.hash) return;
                navigator.clipboard.writeText(issueForm.hash);
          ...
          <input
            ...
            onChange={(e) => {
              ...
              hashFile(file, (hashHex) => setIssueForm({ ...issueForm, hash: hashHex }));
            }}
          />
          {issueFileName ? <p className="muted">File: {issueFileName}</p> : null}
          <div className="row" style={{ marginTop: "12px" }}>
            <button className="btn" onClick={issueCertificate} disabled={!account || !contract}>
              Issue
            </button>
          </div>
        </div>
        ...
        <div className="card">
          ...
          />
          <div className="row" style={{ marginTop: "12px" }}>
            <button className="btn" onClick={revokeCertificate} disabled={!account || !contract}>
              Revoke
            </button>
          </div>
        </div>
